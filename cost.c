...
/*   Updated: 2023/12/12 15:36:38 by lraverdy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	exec_cheapest_move(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (temp_b)
	{
		if (abolute_value(temp_b->cost_a)
			+ abolute_value(temp_b->cost_b) < cheapest_move)
		{
			cheapest_move = abolute_value(temp_b->cost_b)
				+ abolute_value(temp_b->cost_a);
